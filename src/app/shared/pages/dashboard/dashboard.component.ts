...
export class DashboardComponent implements AfterViewInit {
  ...
  getDashboardStats() {
    ...
    let dashboardApi;
    if (this.isAssigner()) {
      dashboardApi = this.userMgmtService.getDashboardStats(
        this.userDetails.loginId,
      );
    } else if (this.isAssignee()) {
      dashboardApi = this.userMgmtService.getAssigneeDashboardStats(
        this.userDetails.loginId,
      );
    } else {
      dashboardApi = this.userMgmtService.getInitiatorDashboardStats(
        this.userDetails.loginId,
      );
    }
