...
@Component({
  selector: 'app-closed-references',
  standalone: false,
  templateUrl: './closed-references.component.html',
  styleUrl: './closed-references.component.css'
})
export class ClosedReferencesComponent implements AfterViewInit {
